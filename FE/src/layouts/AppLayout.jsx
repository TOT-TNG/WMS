  ...
  return (
    <div className="bg-background text-on-background font-body-md min-h-screen flex">
      ...
      <div className="flex-1 ml-60 flex flex-col min-h-screen">
        ...
        <main
          className={`custom-scrollbar flex-1 ${showRightPanel ? "mr-80" : ""} pt-4 px-margin-desktop pb-margin-desktop overflow-y-auto`}
        >
          <Outlet />
        </main>
      </div>

      {showRightPanel && <RightPanel usagePercent={73} />}
    </div>
  );
}
